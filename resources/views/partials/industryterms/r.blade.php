...
<div class="container letter-banner">
    <h4 class="text-center py-1 pt-2">R</h4>
</div>
<ul class="list-group">
    <li class="list-group-item"><strong>Rate Index</strong><br>An index used to adjust the interest rate of an adjustable mortgage loan (e.g., the change in U.S. treasury securities (t–bills) with 1–year maturity. The weekly average yield on said securities, adjusted to a constant maturity of 1 year, which is the result of weekly sales, may be obtained weekly from the federal reserve statistical release. This change in interest rates is the "index" for the change in a specific adjustable mortgage loan.</li>
    <li class="list-group-item"><strong>Real Estate Broker</strong><br>Person or firm that helps their clients buy and sell their real estate for a fee.</li>
    <li class="list-group-item"><strong>Real Estate Investor</strong><br>Someone who purchases properties with the intention of making a profit, either through holding for rental income or reselling it at a premium to cost.</li>
    <li class="list-group-item"><strong>Real Estate Owned (REO)</strong><br>A process where ownership of a property was transferred from an original owner to the owner’s lender through the foreclosure process.</li>
    ...
    <li class="list-group-item"><strong>Replacement Reserves</strong><br>An amount set aside from net operating income to pay for the eventual wearing out of short–lived assets. Monthly deposits that a lender may require a borrower to reserve in an account, along with principal and interest payments for future capital improvements of major building systems; i.e., HVAC, parking lot, carpets, roof, etc.</li>
    <li class="list-group-item"><strong>Reserve Funds</strong><br>Funds a lender requires a Borrower to show in order to close.</li>
    <li class="list-group-item"><strong>Return on Investment (ROI)</strong><br>A measure of the amount of return on an investment relative to the investment’s cost. This is a % derived from the formula: (Net Profit / Cost of Investment) x 100 | for example, if your net profit is $100,000 and your investment costs are $300,000, your ROI would (.33) x 100 = 33%.</li>
    <li class="list-group-item"><strong>Reversionary Value (RV)</strong><br>The value of the property at the expiration of a certain time period.</li>
</ul>